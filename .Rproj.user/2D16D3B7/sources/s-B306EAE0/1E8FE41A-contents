SSWdone <- function(M, code, model, Xobs, Yobs, Dx, Dtheta, sigeps, 
                      ctype="VAR", rprior, dprior, Lopt=1e4, Lmcmc=1e4){
  ...
  for(k in 1:M){
    thetak = optimf(fn=function(t){WSS(t, model, Y=Yobs, X=Xobs, sigeps)}, 
                    Domain=Dtheta, L=Lopt, tomax=TRUE)
